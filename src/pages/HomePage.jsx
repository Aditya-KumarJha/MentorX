    ...
    <div className={`min-h-screen transition-all duration-300 ${bgColor}`}>
      ...
      <section className={`relative text-center py-28 px-6 sm:px-10 md:px-20 ${bgColor} transition-all duration-300 select-none`}>
        <div className="relative z-10">
          ...
          >
            <Typewriter
              words={['Empower your future.', 'Discover your path.', 'Grow with AI guidance.']}
              loop={0}
              cursor
              cursorStyle="|"
              typeSpeed={70}
          ...
          >
            <button className="px-6 py-2 font-semibold rounded-full bg-indigo-500 hover:bg-indigo-600 text-white shadow-md transition-all">
              Get Started
            </button>
            <button
